...
Версия 10.0 - Полная версия с АБСОЛЮТНЫМ сохранением шрифтов Montserrat, исправлением экранирования спецсимволов
и улучшенным масштабированием круглых хедшотов
"""
...
def process_svg_font_perfect(svg_content, replacements):
    ...
    - Улучшенное масштабирование круглых хедшотов
    """
        ...
        if is_image_field(dyno_field):
            ...
            if match:
                ...
                if pattern_match:
                    ...
                    # Для круглых хедшотов добавляем масштабирование
                    if element_shape == 'circular' and image_type == 'headshot':
                        # Применяем масштабирование для круглых хедшотов
                        print(f"      🔍 Применяем масштабирование для круглого хедшота")
